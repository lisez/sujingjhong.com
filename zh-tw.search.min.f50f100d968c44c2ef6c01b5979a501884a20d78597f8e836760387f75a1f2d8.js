...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh-tw.search-data.min.1283857adef7be8dd698f2b6fb81f25dc797b839599ece83a1a284beabcc445e.js',function(){input.required=false;search();});}
